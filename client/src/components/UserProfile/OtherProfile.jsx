...
//                   variant="h4"
//                   sx={{}}
//                 >{`${otherUser.first_name} ${otherUser.last_name}`}</Typography>
//                 <Typography
//                   variant="body1"
//                   sx={{ pl: 1, pt: 1.5 }}
//                 >{`( ${otherUser.username} )`}</Typography>
//               </Box>
//               <Box sx={{ mr: 8, pr: 3, display: "flex" }}>
//                 {otherUser.user_organizations &&
//                 otherUser.user_organizations.length > 0 ? (
//                   <List>
//                     {otherUser.user_organizations.map((group, i) => (
//                       <ListItem key={i}>
//                         <ListItemAvatar>
...
//             <Box sx={{ px: 3 }}>
//               <Button
//                 onClick={(e) => setOpenResume(true)}
//                 variant="contained"
//               >{`${otherUser.first_name}'s Resume`}</Button>
//             </Box>
//             <Box>
//               <Dialog
//                 open={openResume}
